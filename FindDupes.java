...
public class FindDupes {
    ...
    public static void main(String... args) throws IOException {
        if (args.length == 0) {
            ...
            System.err.println("  --min=NUMB        minimal similarity in percent");
            System.err.println("  --minws=NUMB      minimal similarity in percent with whitechars removed");
            System.err.println("                    Note, that min/minws should be 0-100 inclusive. Bigger/higher will effectively exclude the method.");
            System.err.println("  --case=true/false if false, similarity is case insensitive");
            System.err.println("  --fitler=EXPRES   file path filter regex");
            System.err.println("  --exclude[=EXPRES]sources exclude list exclude matching source files form run. Eg \"" + DEFAULT_EXCLUDES + "\"");
            System.err.println("  --eraser[=EXPRES] remove matching (comment?) lines if enabled, default is " + DEFAULT_COMMENTS);
            System.err.println("  --names=false/true/icase/NUMBER/");
            System.err.println("                    will compare only if filenames are same/similar");
            System.err.println("                    false - not used, comapre all. true filenames must be same before comaprison");
            System.err.println("                    icase - like true, only9 case insensitive. NUMBER - names must be similar (percentages) ");
            System.err.println("  --verbose         verbose mode");
            System.err.println("  --html            will add html table to stdout");
            System.err.println("  --maxsize=NUMBER  maximum filesize in KB   ");
            System.err.println("                    Default is 100 (100kb), which eats about 46GB ram and taks 5-8 minutes.");
            System.err.println("                    Biggrer files may cause OOM/crash");
            System.err.println("  --minsize=NUMBER  minumum filesize in B. Default 10  ");
            System.err.println("  --maxratio=DOUBLE maximum filesize diff ratio");
            System.err.println("                    Default is 10. Unless target/n < source < target*N then comparison will be skipped.");
            System.err.println("                    Processed after comment removal");
            System.err.println("  --port[=NUMBER]   port to get progress and info");
            System.err.println("                    if enabled, it will reply pid@host time since lunch/eta; default port is " + (-1 * port) + "");
            System.err.println("                    The server will block program from exit.");
